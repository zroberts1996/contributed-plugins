...
ClssPlugin.prototype.translations = {
    'en-CA': {
        ...
        draw: {
            ...
            point: 'Draw point',
            line: 'Measure using line',
            polygon: 'Measure using polygon',
            edit: 'Edit existing drawing',
            measure: 'Show/Hide measurements',
            extent: 'Query selected extent',
    ...
    'fr-CA': {
        ...
        draw: {
            ...
            line: 'Mesurer en utilisant la ligne',
            polygon: "Mesurer à l'aide d'un polygone",
            edit: 'Éditer les dessins existant',
            measure: 'Afficher/Cacher les distances',
            extent: "Interroger l'étendue sélectionnée",
