...
export class DrawToolbar {
    ...
    createTable(panel) {
        return function(queryResults) {  
            const columns = ['Plan Number', 'Description']
    ...
    QueryLayer(ext) {
        //selects polygons within the extent of drawing tools polygon
          ...
          const parcelQueryURL = "http://proxyinternet.nrcan.gc.ca/arcgis/rest/services/MB-NC/WMB_Query_CA/MapServer/0";
          ...
          parcelQuery.outFields = ["PLANNO", "P2_DESCRIPTION"];
