    ...
    angularControls(tools: string[]) {
        ...
        this.mapApi.agControllerRegister('DrawToolbarCtrl', function () {
            const controls = {
                ...
                rectangle: {
                    name: 'rectangle',
                    label: 'plugins.clssPlugin.draw.rectangle',
                    ...
                    tooltip: 'plugins.clssPlugin.draw.rectangle',
                    active: false,
                    createIcon: () => { that.createIcon(this.controls.rectangle) },
                    selected: () => this.controls.rectangle.active,
                    action: () => {
                        that.setActive(this.controls, 'rectangle');
                    }
                },
                write: {
                    name: 'write',
